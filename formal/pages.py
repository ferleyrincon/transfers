...
class Decision(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            ...
            'progress':    progress,
            "camila" : self.participant.vars['camila'],
            'sure_payoff': "$"+format(int(str((self.participant.vars['icl_sure_payoffs_p3'][page - 1])).split(",")[0]), ',d')
        }
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        sure_payoff = self.player.participant.vars['icl_sure_payoffs_p3'][choice_to_pay - 1]
